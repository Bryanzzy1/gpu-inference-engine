...
The headline artifact is a **2D frontier** over (batch size x arrival rate), which shows
...
The CPU wins at batch 1 (in-cache, no launch or PCIe) and holds the p999 grid on my WDDM
...
Because a single p999 is noisy here, quantify it:
